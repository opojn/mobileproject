...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final BadlogicgamesLibraryAccessors laccForBadlogicgamesLibraryAccessors = new BadlogicgamesLibraryAccessors(owner);
    private final Jbox2dLibraryAccessors laccForJbox2dLibraryAccessors = new Jbox2dLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>badlogicgames</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public BadlogicgamesLibraryAccessors getBadlogicgames() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForBadlogicgamesLibraryAccessors;
    }

    /**
     * Group of libraries at <b>jbox2d</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Jbox2dLibraryAccessors getJbox2d() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForJbox2dLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class BadlogicgamesLibraryAccessors extends SubDependencyFactory {

        public BadlogicgamesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>gdx</b> with <b>com.badlogicgames.gdx:gdx</b> coordinates and
         * with version reference <b>badlogicgamesGdx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getGdx() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("badlogicgames.gdx");
        }
     ...
     */
    @Deprecated
    public static class Jbox2dLibraryAccessors extends SubDependencyFactory {

        public Jbox2dLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>library</b> with <b>org.jbox2d:jbox2d-library</b> coordinates and
         * with version reference <b>jbox2dLibrary</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>badlogicgamesGdx</b> with value <b>1.11.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBadlogicgamesGdx() { return getVersion("badlogicgamesGdx"); }
        ...
        /**
         * Version alias <b>jbox2dLibrary</b> with value <b>2.2.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJbox2dLibrary() { return getVersion("jbox2dLibrary"); }
